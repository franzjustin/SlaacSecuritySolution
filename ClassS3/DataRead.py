...
class DataRead:
    ...
    #Special function for DOS on DAD
    @property
    def getSlaacUsingSLL(self):
        ...
        i = 1
        for ts, buf in pcap:
            sll = LinuxSLLDecoder().decode(buf)
            sllChild = sll.child()
            sllChild2 = sllChild.child()
            ...
            try:
                ...
                if sll.get_size() == 80:
                    ...
                    packetData = (sllChild2.get_originating_packet_data())
                    packetHex = []
                    ...
                    target_address = ""
                    ip_source_address = sllChild2.get_source_address()
                    ip_destination_address = sllChild.get_destination_address()
                    ndp_message_number = sllChild2.get_type()
                    x = 0
                    #print packetHex
